...
//Prosthiki Neas Eikonas gia Background - 1/12/2022
PImage NewBgImage;

// How different must a pixel be to be a foreground pixel
float threshold = 20;

/*Prospatheia1: Afisa to threshold ws exei, kai apla pathsa to mouseKey mia fora, meta to ksanapathsa allh mia - gia na kanei kati san "refresh" 
kai leitourghse :)*/
    ...
    for (int y = 0; y < video.height; y ++ ) {
      ...
      if (diff > threshold) {
        ...
        //image(NewBgImage, 0, 0);               Try 03
          pixels[loc] =  NewBgImage.pixels[loc]; //Try 04 - Ayto einai to swsto, apla xreiazetai na ftiaksw tin eikona hell giati emfanizetai sympiesmeni
      }
    }
  }
  updatePixels();
